...
const LeftRightSection = ({ alignment, heading, title, paragraph, image, inverse, exploreLink, pricingLink, theme, appleLink, androidLink }) => {
    return (
        <>
            {
                theme == "light" ? <>
                        ...
                        <Container>
                            {
                                inverse ? <>
                                    ...
                                    <Row className="flex-column-reverse flex-md-row flex-lg-row row">
                                        {
                                            (alignment == 'right') ? <Col lg={6} md={6} xs={12} className="align-self-center d-flex flex-column justify-content-end text-end">
                                                {
                                                ...
                                                <Row className="justify-content-end w-100">
                                                    {
                                                        (appleLink || androidLink) ? <>
                                                            <Col lg={6} md={6} xs={12} className="align-self-center d-flex  justify-content-end text-end">
                                                                {
                                                                    (appleLink) ? <a href={appleLink} className=" text-light btn d-inline w-auto">
                                                                        <i class="fab fa-apple"></i>
                                                                    </a> : ""
                                                                }

                                                                {
                                                                    (appleLink) ? <a href={androidLink} className=" text-light btn d-inline w-auto">
                                            ...
                                            </Col> : <Col lg={6} md={6} xs={12} className="align-self-center ">
                                                <h1>
                                                    {title}
                                                </h1>
                                                <p>
